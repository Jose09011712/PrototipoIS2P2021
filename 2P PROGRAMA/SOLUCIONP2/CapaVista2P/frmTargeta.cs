...
{
    public partial class frmTargeta : Form
    {
        ClsControlador Cn = new ClsControlador();
        string UsuarioAplicacion;
        static Form FormularioPadre;
        public frmTargeta(string usuario, Form formularioPadre)
        {
            InitializeComponent();
            UsuarioAplicacion = usuario;
            navegador1.Usuario = UsuarioAplicacion;
            FormularioPadre = formularioPadre;
            procLlenarCmb("cliente", "nombre", "estado", comboBox1);
        }
        ...
        {
            txtEstado.Text = (comboBox1.SelectedIndex + 1).ToString();
        }
